...
//
//  analogWrite(enB, 220);
//  double pos1 = getPosition(2);
//  Serial.print("Postion = ");
//  Serial.println(pos1);
//  delay(1000);
//    moveMotorPosition(2,250);
//    delay(3000);
//  
//  
//    moveMotorPosition(2,30);
//    delay(3000);
  ...
  //
  //  pos1 = getPosition(1);
  //  Serial.print("Postion2 waited 3 seconds after stop = ");
  //  Serial.println(pos1);
  //  delay(3000);

  //    int pid = calcPID(2.37, 250, 5);
  //    Serial.println(pid);
...
double getPosition(int motorNumber) {
  ...
  double motorPosition = average2 * 360.0 / 65536.0;
...
/*
   ...
   Inputs motor number (1 or 2) and the degree to move to (0-360).
*/
void moveMotorPosition(int motorNumber, double degree) {
...
/*
   Move motor some distance in specified direction.
   Inputs motor number (1 or 2), direction (-1,1) and number of degrees to move (0 - 330).
   Motor will stop at 30 or 330 as max bound.
*/
...
/*
   ...
   Inputs current and desired angle (0-360) and a constant k.
