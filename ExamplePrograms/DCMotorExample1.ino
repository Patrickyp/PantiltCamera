m/* Example program to run DC Motor with Driver.
 * 
 * Connections:
 * 
...
void demoThree(){
  // this function will move the motors in one direction at a fix speed.
  digitalWrite(in1, LOW);//PIN 9
  digitalWrite(in2, HIGH); //PIN 8
  digitalWrite(in3, LOW);
  digitalWrite(in4, HIGH); 
